...
void kernel_main(void) {
    ...
    swrite("COW1 "); swritehex(my_id); swrite(" start\n");
    swrite("COW1 attempting write to PDE 1 range (0x400000)...\n");
    volatile uint32_t *target = (volatile uint32_t *)0x400000;
    *target = 0xDEADBEEF;
    swrite("COW1 write SUCCEEDED (PDE 1 is writable!)\n");
